    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <InputError
                    class="mt-2"
                    :message="form.errors.password || $page.props.errors.email"
                />
            </div>
            ...
            <div class="block mt-4">
                <label class="flex items-center">
                    ...
                    <span
                        class="ms-2 text-sm text-gray-600 dark:text-gray-400 font-semibold"
                        >Remember me</span
                    >
                </label>
            </div>
            ...
            >
                <span class="text-center w-full">Log in</span>
            </PrimaryButton>
            <Divider class="py-4">
                <span
            ...
            <p class="text-center my-5">
                ...
                <Link
                    :href="route('register')"
                    class="font-semibold text-brand-400"
                >
                    Sign up
                </Link>
            </p>
