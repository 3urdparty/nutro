        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div class="grid grid-cols-2 gap-8 xl:col-span-4">
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" class="mt-4 space-y-4">
                                <li
                                    v-for="item in navigation.categories"
                                    :key="item.name"
                                >
                                    <a
                                        :href="item.href"
            ...
            >
                <div>
                    ...
                    <p class="mt-2 text-base text-gray-300">
                        The latest offers, arrivals, and recipes, sent to your
                        inbox weekly.
                    </p>
                </div>
                <form class="mt-4 sm:flex sm:max-w-md lg:mt-0">
                    ...
                    >
                        <button
                            type="submit"
                            class="w-full bg-blue-500 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-blue-500"
                        >
                            Subscribe
                        </button>
                    </div>
            ...
            >
                ...
                <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                    &copy; 2020 Nutro, Inc. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
