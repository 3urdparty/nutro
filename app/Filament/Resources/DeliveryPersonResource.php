...
use App\Filament\Resources\DeliveryPersonResource\Pages;
use App\Filament\Resources\DeliveryPersonResource\RelationManagers;
...
class DeliveryPersonResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListDeliveryPeople::route('/'),
